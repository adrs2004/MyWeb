...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative z-50 border-t my-12 lg:my-24 border-[#25213b] px-4 sm:px-6 lg:px-8 xl:px-10"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start text-left">
        <div className="relative bg-[#2F2F2F] border border-[#1f223c] p-8 rounded-lg shadow-lg shadow-violet-500">
          <h1 className="font-bold text-2xl text-[#ffbf00] mb-2">
            Need Support?
          </h1>
          <p className="text-[#4beba0] font-light mb-4">
        ...
        <div className="relative w-full h-[400px] md:h-[500px]">
          <div className="absolute bg-violet-500 top-0 right-0 w-[200px] h-[90%] rounded-[20px] hidden lg:block"></div>
